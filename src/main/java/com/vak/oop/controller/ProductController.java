...
public class ProductController implements Initializable {
  ...
  @FXML
  private MFXTableColumn<ProductEntity> pdtype;
  @FXML
  ...
  private void setCol() {
    pdid.setRowCellFactory(_ -> new MFXTableRowCell<>(product -> String.valueOf(product.getPdid())));
    pdname.setRowCellFactory(_ -> new MFXTableRowCell<>(ProductEntity::getPdname));
    pdprice.setRowCellFactory(_ -> new MFXTableRowCell<>(product -> String.valueOf(product.getPdprice())));
    pdtype.setRowCellFactory(_ -> new MFXTableRowCell<>(ProductEntity::getPdtype));
    pdinfo.setRowCellFactory(_ -> new MFXTableRowCell<>(ProductEntity::getPdinfo));
    pdquantity.setRowCellFactory(_ -> new MFXTableRowCell<>(product -> String.valueOf(product.getPdquantity())));
  }
  ...
  private void setWidth() {
    ...
    pdtype.prefWidthProperty().bind(productTable.widthProperty().multiply(0.15));
  ...
  private void exportToExcel() {
    ...
    try (org.apache.poi.xssf.usermodel.XSSFWorkbook workbook = new org.apache.poi.xssf.usermodel.XSSFWorkbook()) {
      ...
      for (int i = 0; i < products.size(); i++) {
        ...
        createCell(row, 3, product.getPdtype(), cellStyle);
