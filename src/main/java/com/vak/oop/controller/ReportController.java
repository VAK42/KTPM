...
public class ReportController implements Initializable {
  ...
  @FXML
  private MFXTableColumn<ReportEntity> userid;
  @FXML
  ...
  private void setCol() {
    ...
    userid.setRowCellFactory(_ -> new MFXTableRowCell<>(report -> report.getUser().getUsername()));
  ...
  private void setWidth() {
    ...
    userid.prefWidthProperty().bind(reportTable.widthProperty().multiply(0.2));
