...
public class ExportController implements Initializable {
  ...
  @FXML
  private MFXTableColumn<ExportEntity> pdtype;
  @FXML
  ...
  private void setCol() {
    ...
    pdname.setRowCellFactory(_ -> new MFXTableRowCell<>(ExportEntity::getPdname));
    pdtype.setRowCellFactory(_ -> new MFXTableRowCell<>(ExportEntity::getPdtype));
  ...
  private void setWidth() {
    epid.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.1));
    pdname.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.3));
    pdtype.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.15));
    pdprice.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.1));
    pdquantity.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.1));
    pdtotalprice.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.15));
    date.prefWidthProperty().bind(exportTable.widthProperty().multiply(0.1));
  }
  ...
  private void createExport() {
    try {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/vak/oop/ExportCreateView.fxml"));
    ...
    if (selectedExport != null) {
      ...
      confirmAlert.showAndWait().ifPresent(response -> {
        if (response == ButtonType.OK) {
          exportService.deleteExport(selectedExport);
          loadExports();
        }
      });
    } else {
  ...
  private void exportToExcel() {
    ...
    try (org.apache.poi.xssf.usermodel.XSSFWorkbook workbook = new org.apache.poi.xssf.usermodel.XSSFWorkbook()) {
      ...
      String[] headers = {"EXPORT ID", "PRODUCT NAME", "TYPE", "PRICE", "QUANTITY", "TOTAL PRICE", "DATE"};
      ...
      for (int i = 0; i < exports.size(); i++) {
        ...
        createCell(row, 1, export.getPdname(), cellStyle);
        createCell(row, 2, export.getPdtype(), cellStyle);
  ...
  private void exportToPdf() {
    ...
    if (file != null) {
      try (com.lowagie.text.Document document = new com.lowagie.text.Document()) {
        ...
        addRow(table, "Product Name:", selectedExport.getPdname());
        addRow(table, "Type:", selectedExport.getPdtype());
